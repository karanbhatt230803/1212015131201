...
//                             <Link href="#" className="hover:text-foreground/80 text-sm">Integration</Link>
//                         </ul>
//                     </nav>
...
const Navbar = async () => {
    ...
    return (
        <header
            className="sticky top-4 inset-x-0 z-50 w-[70%] mx-auto h-14 bg-background/40 backdrop-blur-lg border-2 border-blue-500 rounded-full flex items-center justify-between px-6 shadow-md"
        >
            <div className="flex items-start">
                <Link href="/" className="flex items-center gap-2">
                    <Icons.logo className="w-8 h-8" />
